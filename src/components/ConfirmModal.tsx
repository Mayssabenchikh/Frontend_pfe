...
export function ConfirmModal({
  ...
  const content = (
    <div className="app-modal-backdrop fixed inset-0 z-[200] flex items-center justify-center px-3 py-4 sm:px-4">
      ...
      <div className="no-visible-scrollbar relative max-h-[min(90dvh,640px)] w-full max-w-md overflow-y-auto rounded-3xl border border-violet-500/16 bg-white/[0.9] px-5 py-5 shadow-[0_18px_48px_rgba(109,40,217,0.14)] sm:px-7 sm:py-6">
