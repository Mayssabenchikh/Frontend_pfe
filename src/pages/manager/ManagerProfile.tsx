...
// Note: Manager ne dispose que d'une vue "Informations personnelles"
...
export function ManagerProfile() {
  ...
  // Pas de menu (comme employé) côté Manager
          ...
          {loadingExtra ? (
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                {isEditingExtra ? <ExtraField icon={<BriefcaseIcon className="h-4 w-4" />} label="Poste" value={editJob} onChange={setEditJob} placeholder="ex: Manager de projet" /> : <ReadonlyField icon={<BriefcaseIcon className="h-4 w-4" />} label="Poste" value={extraData.jobTitle || "—"} />}
              </div>
            </div>
          )}
        </div>
