...
export default function EmployeePage() {
  ...
  const isQuizDashboardPage = location.pathname.startsWith("/employee/quiz-dashboard");
  const isQuizPage = location.pathname.startsWith("/employee/quiz") && !isQuizDashboardPage;
          ...
          >
            {({ isActive }) => (
              <>
                ...
                {!sidebarCollapsed && <span className="truncate">Quiz Dashboard</span>}
              </>
            )}
          </NavLink>
